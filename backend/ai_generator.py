...
- **Course outline requests**: Use get_course_outline tool to retrieve course title, course link, and complete lesson list with numbers and titles
...
- **Course outline questions**: Use outline tool first, then answer with course title, link, and all lessons
