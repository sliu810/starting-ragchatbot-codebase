...
class TestRAGSystemIntegration:
    ...
    def test_sources_retrieval_and_reset(self, rag_system):
        ...
        with patch.object(rag_system.tool_manager, 'get_last_sources') as mock_get_sources, \
            ...
            assert sources == [{"text": "MCP Course - Lesson 1", "link": "http://example.com"}]
    ...
    def test_course_analytics(self, rag_system):
        ...
        rag_system.vector_store.get_existing_course_titles.return_value = [
            "MCP Course", "Python Basics", "Advanced AI", "Vector Databases"
        ]
...
class TestRAGSystemRealScenarios:
    ...
    def test_outline_tool_execution_through_rag_system(self, rag_system_with_real_tools):
        """Test that outline tool executes correctly through RAG system"""
        # Setup vector store mock responses
        rag_system_with_real_tools.vector_store._resolve_course_name.return_value = "MCP Course"
